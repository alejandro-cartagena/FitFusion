    ...
    return (
        <div className='home-card'>
            <div className='home-card-icon-container'>
                <img className="home-card-icon" src={FlexIcon} alt="Icon of a man flexing his muscles" srcset="" />
                <h3 className='home-card-icon-text'>Fitness</h3>
            </div>
            <div className='home-card-icon-container'>
                <img className="home-card-icon" src={NutritionIcon} alt="Icon of a plate of healthy food" srcset="" />
                <h3 className='home-card-icon-text'>Nutrition</h3>
            </div>
            <div className='home-card-icon-container'>
                <img className="home-card-icon" src={ClipBoardIcon} alt="Icon of a clipboard with a checklist" srcset="" />
